...
public class Debt extends javax.swing.JFrame {
    ...
    public Debt() {
        this.setExtendedState(Debt.MAXIMIZED_BOTH);
        initComponents();
        fetch();
    }

    public Debt(String message) {
        this.setExtendedState(Debt.MAXIMIZED_BOTH);
        initComponents();
        fetch();
    ...
    private void redirectToUpdate(int row) {
        ...
        new DebtUpdate(updateId).setVisible(true);
        this.setVisible(false);
    }

    public void fetch() {
        try {
            ResultSet rs = dService.getData();
            ...
            while (rs.next()) {
                ...
                String peminjam = rs.getString("name");
                String jumlahpinjaman = rs.getString("jumlah_pinjaman");
                String status = rs.getString("status");

                String tbPerson[] = { id, peminjam, jumlahpinjaman, status };
    ...
    private void initComponents() {
        ...
        }, new String[] { "No", "Peminjam", "Jumlah pinjaman", "status" }) {
